...
<html lang="en">
  ...
  <body id="page-top">
	...
	<?php echo form_open('laporan/update_user') ?>
			  
			  <div class="form-group">
			    <label for="text">Firstname</label>
			    <input type="text" name="firstname" value="<?php echo $user->firstname ?>" class="form-control" placeholder="Masukkan Nomer Induk Karyawan">
			  </div>

			  <div class="form-group">
			    <label for="text">Lastname</label>
			    <input type="text" name="lastname" value="<?php echo $user->lastname ?>"class="form-control" placeholder="Masukkan Nama Karyawan">
			  </div>
