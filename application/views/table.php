      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Pinjam Perpustakaan</li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <button type="button" class="btn-sm btn-outline-primary">VIEW</button>
                <br>
                <br>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    ...
                    <?php foreach ($v_userpinjam as $tbl) :?>
                     ...
                     <td>
                       <a href="<?php echo base_url() ?>laporan/edit/<?php echo $tbl->id_anggota ?>" class="btn-sm btn-primary">EDIT</a>
                       <a href="<?php echo base_url() ?>laporan/hapus/<?php echo $tbl->id_anggota ?>" class="btn-sm btn-danger">HAPUS</a>
                     </td>
                     </tr>
  <?php endforeach ?>
                  </tbody>
