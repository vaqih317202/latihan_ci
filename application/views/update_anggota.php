...
<html lang="en">
  ...
  <body id="page-top">
	...
	<?php echo form_open('laporan/update_anggota') ?>
			  
			  <div class="form-group">
			    <label for="text">ID Anggota</label>
			    <input type="text" name="id_anggota" value="<?php echo $anggota->id_anggota ?>" class="form-control" placeholder="Masukkan Nomer Induk Karyawan">
			  </div>

			  <div class="form-group">
			    <label for="text">NIM</label>
			    <input type="text" name="nim" value="<?php echo $anggota->nim ?>"class="form-control" placeholder="Masukkan Nama Karyawan">
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="email" value="<?php echo $anggota->email  ?>" class="form-control">
			  </div>
