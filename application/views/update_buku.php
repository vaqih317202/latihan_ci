...
<html lang="en">
  ...
  <body id="page-top">
	...
	<?php echo form_open('laporan/update_buku') ?>
			  
			  <div class="form-group">
			    <label for="text">Kode Buku</label>
			    <input type="text" name="kd_buku" value="<?php echo $buku->kd_buku ?>" class="form-control" placeholder="Masukkan Nomer Induk Karyawan">
			  </div>

			  <div class="form-group">
			    <label for="text">judul</label>
			    <input type="text" name="judul" value="<?php echo $buku->judul ?>"class="form-control" placeholder="Masukkan Nama Karyawan">
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="stok" value="<?php echo $buku->stok  ?>" class="form-control">
			  </div>

			  <div class="form-group">
			    <label for="text">Tahun Terbit</label>
			    <input type="date" name="th_terbit" value="<?php echo $buku->th_terbit  ?>" class="form-control">
			  </div>

        <div class="form-group">
          <label for="text">ID Katagori</label>
          <input type="text" name="id_kategori" value="<?php echo $buku->id_kategori  ?>" class="form-control">
        </div>
