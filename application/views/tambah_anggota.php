  ...
  <body id="page-top">
	...
	<?php echo form_open('laporan/simpan_anggota') ?>
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="id_anggota" class="form-control" placeholder="Masukkan Nomer Induk Karyawan">
			  </div>

			  <div class="form-group">
			    <label for="text">NIM</label>
			    <input type="text" name="nim" class="form-control" placeholder="Masukkan Nama Karyawan">
			  </div>
