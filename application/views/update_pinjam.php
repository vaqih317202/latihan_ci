...
<html lang="en">
  ...
  <body id="page-top">
	...
	<?php echo form_open('laporan/update_pinjam') ?>
			  
			  <div class="form-group">
			    <label for="text">Kode Transaksi</label>
			    <input type="text" name="kd_transaksi" value="<?php echo $pinjam->kd_transaksi ?>" class="form-control" placeholder="Masukkan Nomer Induk Karyawan">
			  </div>

			  <div class="form-group">
			    <label for="text">Pinjam</label>
			    <input type="text" name="id_anggota" value="<?php echo $pinjam->id_anggota ?>"class="form-control" placeholder="Masukkan Nama Karyawan">
			  </div>

			  <div class="form-group">
			    <label for="text">Tanggal Pinjam</label>
			    <input type="text" name="tanggal_pinjam" value="<?php echo $pinjam->tanggal_pinjam ?>" class="form-control">
			  </div>

			  <div class="form-group">
			    <label for="text">Tanggal Kembali</label>
			    <input type="text" name="tanggal_kembali" value="<?php echo $pinjam->tanggal_kembali ?>" class="form-control">
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="denda" value="<?php echo $pinjam->denda  ?>" class="form-control">
			  </div>
