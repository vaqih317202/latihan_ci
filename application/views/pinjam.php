          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <a href="<?php echo base_url()?>index.php/laporan/tambah_pinjam" type="button" class="btn-sm btn-outline-primary">TAMBAH BUKU </a>
                <br>
                <br>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    ...
                    <?php foreach ($pinjam as $tbl) :?>
                     ...
                     <td>
                       <a href="<?php echo base_url() ?>index.php/laporan/edit_pinjam/<?php echo $tbl->kd_transaksi ?>" class="btn-sm btn-outline-success">EDIT</a>
                       <a href="<?php echo base_url() ?>index.php/laporan/hapus_pinjam/<?php echo $tbl->kd_transaksi ?>" class="btn-sm btn-outline-warning">HAPUS</a>
                     </td>
                     </tr>
                    <?php endforeach ?>
                  </tbody>
